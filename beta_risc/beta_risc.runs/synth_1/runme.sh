...
HD_PWD='C:/Users/prana/OneDrive/Documents/GitHub/beta-risc/beta_risc/beta_risc.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log beta.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source beta.tcl
